      ...
      <main className="max-w-6xl mx-auto py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 h-auto md:h-[650px] px-4 md:px-20">
          ...
          <div className="flex flex-col gap-4 h-auto md:h-full">
            <div className="relative w-full h-48 md:h-1/2 rounded-2xl overflow-hidden">
              <Image
        ...
        <p className="text-gray-400 text-sm md:text-[20px] font-semibold text-center mb-12 md:mb-70">Trusted by many</p>
        ...
        <div className="mb-12 md:mb-24 px-4">
          <div className="text-center mb-8 md:mb-22">
            ...
            <p className="text-gray-700 text-base md:text-lg font-light mt-2">We provide tools and spaces designed to support your emotional well-being, wherever you are in your journey.</p>
          </div>
          ...
          <p className="text-gray-900 text-center text-sm md:text-md font-light m-6 md:m-10">"Healing isn't linear — but it's real."</p>
        </div>
        ...
        <div className="text-center mb-12 md:mb-24 mt-20 md:mt-56 px-4 md:px-43">
          ...
          <p className="text-gray-700 text-sm md:text-md mb-8 font-light">
        ...
        <div className="text-center mt-20 md:mt-56 px-4 md:px-43">
          <h2 className="text-lg font-medium mb-4">The Hearts Behind Heartivy</h2>
          <p className="text-gray-700 text-sm md:text-md font-light mb-8">
        ...
        <div className="text-center mt-20 md:mt-56 px-4 md:px-43">
          <h2 className="text-lg font-medium mb-4">Stories of Hope</h2>
          <p className="text-gray-700 text-sm md:text-md font-light mb-8">
            Real voices from our community sharing their experiences of healing and connection
          </p>
        </div>
      </main>

      {/* --- Stories Section --- */}
  <section className="mt-8 md:mt-16 px-4 md:px-6 mb-70">
        <div className="mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-x-45 md:gap-y-20 px-2 md:px-30">

            <div className="flex justify-start">
              <blockquote className="bg-gray-100 rounded-2xl px-4 sm:px-6 md:px-8 py-6 md:py-8 w-full">
                <p className="text-xs sm:text-sm md:text-base font-medium leading-relaxed text-gray-700 text-center">
                  "Heartivy helped me open up for the first time. I never thought I could share my feelings so freely, but the community here made me feel safe and understood."
                </p>
              </blockquote>
            </div>
            ...
            <div className="flex justify-start md:justify-end">
              <blockquote className="bg-gray-100 rounded-2xl px-4 sm:px-6 md:px-8 py-6 md:py-8 w-full">
                <p className="text-xs sm:text-sm md:text-base font-medium leading-relaxed text-gray-700 text-center">
                  "It's not therapy — it's comfort from someone who just understands. Sometimes that's exactly what you need to get through a tough day."
                </p>
              </blockquote>
            </div>
            ...
            <div className="flex justify-start">
              <blockquote className="bg-gray-100 rounded-2xl px-4 sm:px-6 md:px-8 py-6 md:py-8 w-full">
                <p className="text-xs sm:text-sm md:text-base font-medium leading-relaxed text-gray-700 text-center">
                  "The anonymous chats gave me courage to speak about things I'd been holding in for years. I finally feel like I'm not carrying this weight alone."
                </p>
              </blockquote>
            </div>
            ...
            <div className="flex justify-start md:justify-end">
              <blockquote className="bg-gray-100 rounded-2xl px-4 sm:px-6 md:px-8 py-6 md:py-8 w-full">
                <p className="text-xs sm:text-sm md:text-base font-medium leading-relaxed text-gray-700 text-center">
                  "Heartivy reminded me that vulnerability is not weakness. It's the first step toward healing, and I'm grateful for this community every day."
                </p>
              </blockquote>
            </div>
...
function FeatureCard({ img, title, desc }: FeatureCardProps) {
  return (
    <div className="bg-[#EAEAEA] rounded-xl pt-6 md:pt-10 px-4 md:px-8 pb-4 flex flex-col items-center text-center shadow-lg transition">
      ...
      <p className="text-gray-400 text-[13px] md:text-[14px] font-light">{desc}</p>
    </div>
  );
}
...
function Badge({ color, text }: BadgeProps) {
  return (
    <span className={`${color} px-4 md:px-6 py-2 rounded-full text-[12px] md:text-[14px] font-bold shadow-[inset_0_0_18px_rgba(255,255,255,0.4),inset_0_0_6px_rgba(0,0,0,0.1)]`}>
      {text}
    </span>
  );
}
